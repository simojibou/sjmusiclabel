        ...
        <section className="mb-20 flex flex-wrap justify-between px-5">
          <div className="w-full lg:w-1/4">
            <div className="relative h-[500px] w-full">
              <Image src={poster} layout="fill" objectFit="contain" alt="Event poster" />
            </div>
          ...
          <div className="w-full overflow-hidden p-2 px-4 lg:w-[70%]">
            ...
            <p className="my-3 flex text-xl text-zinc-100">
              ...
              <a href="https://www.youtube.com/@simojibou" target="_blank" rel="noopener noreferrer">
                <FaYoutube className="mx-5 hover:text-lime-400" />
              </a>
              <a href="https://open.spotify.com/artist/435SbwFjs0ZPb6dchnjfZS" target="_blank" rel="noopener noreferrer">
